...
<div id="wrapper">
	...
	<div id="main"><!-- Main contents -->
		...
		<div id="insideheader">Privacy Policy
		</div>
		<hr>
...
<div id="maininfo">	
		<p>This Privacy Policy governs the manner in which Deezy Inc collects, uses, maintains and discloses information collected 
		from users (each, a "User") of the http://titan.csit.rmit.edu.au/~s3083090/W/A1/ website ("Site"). This privacy policy 
		applies to the Site and all products and services offered by Deezy Inc.</p>

		<p><b>Personal identification information</b></p>


		<p>We may collect personal identification information from Users in a variety of ways, including, but not limited to, when 
		Users visit our site, place an order, and in connection with other activities, services, features or resources we make 
		available on our Site. Users may be asked for, as appropriate, name, phone number. Users may, however, visit our Site 
		anonymously. We will collect personal identification information from Users only if they voluntarily submit such 
		information to us. Users can always refuse to supply personally identification information, except that it may prevent
		 them from engaging in certain Site related activities.</p>
		...
		<p>Deezy Inc may collect and use Users personal information for the following purposes:</p>
		...
		We may use information in the aggregate to understand how our Users as a group use the services and resources provided 
		on our Site.<br><br>

		<em>To improve our Site:</em><br>
		We may use feedback you provide to improve our products and services.<br><br>

		<em>To process payments:</em><br>
		We may use the information Users provide about themselves when placing an order only to provide service to that order.
		 We do not share this information with outside parties except to the extent necessary to provide the service.<br><br>

		<em>To send periodic emails:</em><br>
		We may use the email address to send User information and updates pertaining to their order. It may also be used to
		 respond to their inquiries, questions, and/or other requests.<br>
		...
		<p>Deezy Inc has the discretion to update this privacy policy at any time. When we do, we will post a 
		...
		<p>By using this Site, you signify your acceptance of this policy and terms of service. If you do not
		 agree to this policy, please do not use our Site. Your continued use of the Site following the posting
		 of changes to this policy will be deemed your acceptance of those changes.</p>
		...
		Deezy Inc<br>
		http://titan.csit.rmit.edu.au/~s3083090/W/A1/<br>
		13 Drummond St, Melbourne 3000<br>
		0400 000 000<br>
		<em>deezyinc@gmail.com</em></p>

		<p>This document was last updated on March 28, 2014</p>

		<p><em>Privacy policy created by Generate Privacy Policy</em></p>
